...
// Access Point Info
// In case there is no WiFi Network or Ahoy can not connect to it, it will act
// as an Access Point

#define WIFI_AP_SSID "AHOY-DTU"
#define WIFI_AP_PWD "esp_8266"

// If the next line is uncommented, Ahoy will stay in access point mode all the
// time
// #define AP_ONLY
...
// maximum total payload buffers (must be greater than the number of received
// frame fragments)
...
// number of seconds since last successful response, before inverter is marked
// inactive
...
//   previous day may contain variable like mCalculatedTimezoneOffset
