...
double round3(double value) { return (int)(value * 1000 + 0.5) / 1000.0; }
...
String getDateTimeStr(time_t t) {
  ...
  if (0 == t)
    ...
    sprintf(str, "%04d-%02d-%02d %02d:%02d:%02d", year(t), month(t), day(t),
...
String getDateTimeStrFile(time_t t) {
  ...
  if (0 == t)
    ...
    sprintf(str, "%04d-%02d-%02d_%02d-%02d-%02d", year(t), month(t), day(t),
            hour(t), minute(t), second(t));
  return String(str);
}
...
String getDateTimeStrShort(time_t t) {
  ...
  if (0 == t)
    ...
    sprintf(str + 4, "%2d.%3s %02d:%02d", day(t), monthShortStr(month(t)),
            hour(t), minute(t));
  }
  return String(str);
}
