...
void create_screen_main() {
                            ...
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  {
    ...
    }
    {
      ...
      lv_obj_add_event_cb(obj, action_button_pressed, LV_EVENT_PRESSED,
                          (void*)0);
    ...
    }
    {
      ...
      lv_obj_set_style_bg_color(obj, lv_color_hex(0xff101010),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    }
    {
      ...
      lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
      lv_obj_set_style_text_color(obj, lv_color_hex(0xff2196f3),
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_label_set_text(obj, "9999.9");
    }
    {
    ...
    }
    {
      ...
      lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
      lv_obj_set_style_text_color(obj, lv_color_hex(0xff1fff1f),
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    }
    {
      ...
      lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
      lv_obj_set_style_text_color(obj, lv_color_hex(0xff3030ff),
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
